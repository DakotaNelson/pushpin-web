...
sudo docker run --name pushpin -p 8000:8000 -p 8001:8001 --link pushpin-postgres:postgres -e POSTGRES_PASSWORD=mysecretpassword -e PUSHPIN_PASSWORD=test -e SECRET_KEY=asdf1234!@#$jkl;5678%^&*[]{}qwertyuiop -d dakotanelson/pushpin
